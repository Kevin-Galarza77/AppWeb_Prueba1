<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Manage and log out your active sessions on other browsers and devicesAdministre y cierre sesión en sus sesiones activas en otros navegadores y dispositivos.') }}
    </x-slot>
